...
namespace TicTacToeNew
{
    public partial class Form1 : Form
    {
        ...
        VideoScreen clientVideo;
        bool isSecondClientConnected = false;
            ...
            try
            {
                ...
                if (server.Connected)
                {
                    ...
                    this.BeginInvoke((MethodInvoker)delegate ()
                    {
                        ...
                        //if (isSecondClientConnected)
                        //{
                        clientVideo = new VideoScreen();
                        clientVideo.Show();
                        //}
        ...
        void Start_Receive(Socket server)
        {
            ...
            while (server.Connected)// while client is connected to the server
            {
                ...
                //if (text.Contains("VIDEO_FRAME"))
                //{
                //    clientVideo.StartReceive(server);
                //}
